...
{
    public interface IGenericMemoryCache<TCacheItemData>  
    {
        ...
        /// <returns></returns>
        bool AddItem(string key, TCacheItemData itemToCache);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        TCacheItemData GetItem(string key);

        bool SetItem(string key, TCacheItemData itemToCache);
        ...
        /// <param name="itemToCache"></param>
        /// <returns></returns>
        bool UpdateItem(string key, TCacheItemData itemToCache);
        ...
        void AddItems(Dictionary<string, TCacheItemData> itemsToCache);
